...
#SBATCH --job-name="gst_mat_0lin"
#SBATCH --output="laporta_run_mtmhbe_ET0_linear_grid_study.out"

module load matlab/R2022a
cd /home/lynch/boltzmann_solvers/mtmhbe_solver/performance/laporta/grid_study/grid_sweep_data/
matlab -nodisplay -nosplash -nodesktop -r "laporta_mtmhbe_ET0_linear;exit;"
