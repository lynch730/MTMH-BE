...
cd /home/lynch/boltzmann_solvers/mtmhbe_solver/solvers_fortran/stephens_benchmark/
rm *.o *.mod
module purge
module load intel
...
ifort $FFLAGS -I/shared/hpc/matlab/$MATLAB_VER/extern/include -c ../source/solver_td.f90
ifort $FFLAGS -I/shared/hpc/matlab/$MATLAB_VER/extern/include -c ../source/solver_qss.f90
ifort $FFLAGS -I/shared/hpc/matlab/$MATLAB_VER/extern/include -c stephens_benchmark.f90
ifort *.o  $FFLAGS -L/shared/hpc/matlab/$MATLAB_VER/bin/glnxa64 -L/shared/hpc/matlab/$MATLAB_VER/sys/os/glnxa64 -o stephens_benchmark_exe -lmx -lmat -lstdc++
