...
ifort $FFLAGS -I/shared/hpc/matlab/$MATLAB_VER/extern/include -c time_dependent_pulse.f90
ifort *.o  $FFLAGS -L/shared/hpc/matlab/$MATLAB_VER/bin/glnxa64 -L/shared/hpc/matlab/$MATLAB_VER/sys/os/glnxa64 -o loki_b_pulse_exe -lmx -lmat -lstdc++
