...
program laporta_perf_test
    ...
    ispec_array = (/ 1, 1, 2, 3, 4, 6, 7, 9, 11, 13, 16, 20, 25, 31, 38, 48, 59 /);
    Nsim = size(ispec_array, 1)
    ...
    if (iargc()>0) then
        ...
        dname = 'data\laporta_2_files_100\'
    end if
