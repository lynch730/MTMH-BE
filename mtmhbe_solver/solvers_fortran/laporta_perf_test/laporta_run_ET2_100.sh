...
#SBATCH --job-name="for_lap_2_100"
#SBATCH --output="laporta_run_mtmhbe_ET2_100_fortran.out"
...
./laporta_exe '../data/laporta_2_files_100/' > /home/lynch/boltzmann_solvers/mtmhbe_solver/performance/laporta/perf_test/nvib_sweep_data/laporta_mtmhbe_ET2_log_fortran_100.txt
