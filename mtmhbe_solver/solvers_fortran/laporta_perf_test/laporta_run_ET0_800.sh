...
#SBATCH --job-name="for_lap_0_800"
#SBATCH --output="laporta_run_mtmhbe_ET0_800_fortran.out"
...
./laporta_exe 'laporta_0_files_800/' > /home/lynch/boltzmann_solvers/mtmhbe_solver/performance/laporta/perf_test/nvib_sweep_data/laporta_mtmhbe_ET0_log_fortran_800.txt
