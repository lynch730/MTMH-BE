...
./laporta_exe '../data/laporta_2_files_147/' > /home/lynch/boltzmann_solvers/mtmhbe_solver/performance/laporta/grid_study/nvib_sweep_data/laporta_mtmhbe_ET2_log_fortran.txt
