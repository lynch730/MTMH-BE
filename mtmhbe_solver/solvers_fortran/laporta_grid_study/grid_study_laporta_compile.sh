...
ifort $FFLAGS -I/shared/hpc/matlab/$MATLAB_VER/extern/include -c laporta_grid_study.f90
ifort *.o  $FFLAGS -L/shared/hpc/matlab/$MATLAB_VER/bin/glnxa64 -L/shared/hpc/matlab/$MATLAB_VER/sys/os/glnxa64 -o grid_study_laporta_exe -lmx -lmat -lstdc++
